'use strict';
const TASK_COUNT = 3;
// функция, возвращающие разметку компонента Меню
...
// функция, возвращающие разметку компонента Фильтры
...
// функция, возвращающие разметку компонента Список задач
...
const createEditCardTaskTemplate = () => {
  return (
